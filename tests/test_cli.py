...
class TestCliMain:
    ...
    def test_main_successful_processing(self, mock_tqdm, mock_parse_args, mock_process_pmc_ids):
    ...
    def test_main_with_failures(self, mock_tqdm, mock_parse_args, mock_process_pmc_ids):
        ...
        mock_process_pmc_ids.return_value = {'12345': True, '67890': False, '99999': True}
    ...
    @patch('pmcgrab.cli.pmcgrab_cli._parse_args')
    @patch('pmcgrab.cli.pmcgrab_cli.tqdm')
    def test_main_large_batch_chunking(self, mock_tqdm, mock_parse_args, mock_process_pmc_ids):
        ...
        def mock_process_chunk(chunk, workers):
            return {pid: True for pid in chunk}
