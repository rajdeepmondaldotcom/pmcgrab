...
class TestCLIComplete:
    ...
    def test_main_with_negative_batch_size(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            test_args = [
                ...
                "--pmcids", "7114487",
                "--output-dir", str(output_dir),
                "--batch-size", "-1"  # Negative batch size
            ]
    ...
    def test_main_with_large_batch_size(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            test_args = [
                ...
                "--pmcids", "7114487", "3084273",
                "--output-dir", str(output_dir),
                "--batch-size", "1000"  # Very large batch size
            ]
    ...
    def test_main_with_duplicate_pmcids(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            test_args = [
                "pmcgrab_cli.py",
                "--pmcids", "7114487", "7114487", "3084273",  # Duplicate
                "--output-dir", str(output_dir)
            ]
    ...
    def test_main_with_mixed_valid_invalid_pmcids(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            test_args = [
                "pmcgrab_cli.py",
                "--pmcids", "7114487", "invalid", "3084273",
                "--output-dir", str(output_dir)
            ]
