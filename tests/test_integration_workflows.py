...
class TestEndToEndWorkflows:
    ...
    def test_complete_workflow_with_real_pmcids(self, mock_efetch, pmcid):
        ...
        mock_context.__enter__.return_value.read.return_value = mock_xml_responses[
            pmcid
        ].encode("utf-8")
    ...
    def test_batch_processing_workflow(self):
        ...
        with patch("pmcgrab.application.processing.build_paper_from_pmc") as mock_build:
            ...
            for i, pmcid in enumerate(REAL_PMC_IDS):
                ...
                mock_section.get_section_text.return_value = (
...
class TestErrorHandlingScenarios:
    ...
    def test_network_timeout_scenarios(self):
        ...
        with patch("pmcgrab.fetch.Entrez.efetch") as mock_efetch:
            ...
            mock_context = MagicMock()
            mock_context.__enter__.return_value.read.side_effect = TimeoutException(
                "Network timeout"
            )
            mock_efetch.return_value = mock_context
...
class TestEdgeCaseScenarios:
    ...
    def test_email_rotation_workflow(self):
        ...
        with patch(
            "pmcgrab.infrastructure.settings.next_email", side_effect=mock_next_email
        ):
            with patch(
                "pmcgrab.application.processing.build_paper_from_pmc"
            ) as mock_build:
...
class TestPerformanceAndStress:
    ...
    def test_large_batch_processing(self):
        ...
        with patch("pmcgrab.application.processing.build_paper_from_pmc") as mock_build:
            ...
            assert (
                processing_time < 10
            )  # Should complete within 10 seconds with mocking
