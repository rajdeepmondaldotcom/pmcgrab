...
for RAG applications (Version 0.3.1) [Computer software].
...
for RAG applications." GitHub, version 0.3.1, 2024,
https://github.com/rajdeepmondaldotcom/pmcgrab
```
...
```
Mondal, Rajdeep. "PMCGrab: AI-ready retrieval and parsing of PubMed Central articles
for RAG applications." Version 0.3.1. Computer software. GitHub, 2024.
https://github.com/rajdeepmondaldotcom/pmcgrab
```
