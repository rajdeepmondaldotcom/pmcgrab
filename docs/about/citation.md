...
for RAG applications (Version 0.5.6) [Computer software].
...
for RAG applications." GitHub, version 0.5.6, 2025,
https://github.com/rajdeepmondaldotcom/pmcgrab
```
...
```
Mondal, Rajdeep. "PMCGrab: AI-ready retrieval and parsing of PubMed Central articles
for RAG applications." Version 0.5.6. Computer software. GitHub, 2025.
https://github.com/rajdeepmondaldotcom/pmcgrab
```
