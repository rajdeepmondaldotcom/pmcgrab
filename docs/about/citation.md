...
for RAG applications (Version 0.5.0) [Computer software].
...
for RAG applications." GitHub, version 0.5.0, 2025,
https://github.com/rajdeepmondaldotcom/pmcgrab
```
...
```
Mondal, Rajdeep. "PMCGrab: AI-ready retrieval and parsing of PubMed Central articles
for RAG applications." Version 0.5.0. Computer software. GitHub, 2025.
https://github.com/rajdeepmondaldotcom/pmcgrab
```
